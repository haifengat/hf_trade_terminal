...
namespace HaiFeng
{
	public partial class HFForm : Form
	{
		...
		private void buttonLogin_Click(object sender, EventArgs e)
		{
			...
			_t = (Trade)Activator.CreateInstance(ass.GetType($"HaiFeng.{svr.Type}Trade"));
			_broker = svr.Type == ProxyType.Tdx ? this.textBoxExt.Text : svr.Broker;
			_server = svr.TradeAddr;
